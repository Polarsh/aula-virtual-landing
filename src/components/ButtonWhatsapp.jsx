export default function ButtonWhatsAppComponent() {
  return (
    <a
      href='https://wa.me/51926672220?text=Hola,%20estoy%20interesado%20en%20tu%20servicio.'
      className='fixed right-4 bottom-4 z-50 bg-green-500 text-white rounded-full p-2 hover:bg-green-600 shadow-md'
      target='_blank'
