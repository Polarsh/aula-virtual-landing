...
const footerNavigation = {
  contact: [
    { name: '+51 999 999 999', href: 'tel:+51999999999' },
    { name: 'contacto@contacto.com', href: 'mailto:contacto@contacto.com' },
    {
      name: 'Av. Test xxx, Lima',
      href: 'https://www.google.com/maps?q=Avenida+La+Encalada+1420,Surco,+Lima',
    },
  ],
  links: [
    ...
    <footer className='bg-gray-900' aria-labelledby='footer-heading'>
      ...
      <div className='mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32'>
        <div className='grid grid-cols-3 xl:gap-8'>
          ...
          {/* Contacto y Compañia */}
          <div className='mt-16 grid grid-cols-2 gap-8 col-span-3 sm:col-span-2 xl:mt-0'>
            {/* Contacto */}
        ...
        <div className='mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24'>
          <p className='text-xs leading-5 text-gray-400'>
            &copy; 2024 Aula Virtual, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
